...
def test():
    ...
    r1 = M.Resource(
        PicHash="81c26f889ba6ed12f97efbac639802812c687b4ffcc88ea75d6a8d077328b3bf",
        Name="r1",
        PicHeight=32, PicWidth=64,
        Model='steve', Type="skin",
        Owner=a2
    )
    r2 = M.Resource(
        PicHash="8e364d6d4886a76623062feed4690c67a23a66c5d84f126bd895b903ea26dbee",
        Name="r2",
        PicHeight=32, PicWidth=64,
        Model='none', Type='cape',
        Owner=a2
    )
    r3 = M.Resource(
        PicHash="490bd08f1cc7fce67f2e7acb877e5859d1605f4ffb0893b07607deae5e05becc",
        Name="r3",
        PicHeight=32, PicWidth=64,
        Model='alex', Type='skin',
        Owner=a3
    )
    r4 = M.Resource(
        PicHash="ddcf7d09723e799e59d7f19807d0bf5e3a2c044ce17e76a48b8ac4d27c0b16e0",
        Name="r3",
        PicHeight=32, PicWidth=64,
        Model='none', Type='cape',
        Owner=a3
    ...
    c1 = M.Character(
        PlayerId=OfflinePlayerUUID("character1"),
    ...
    c2 = M.Character(
        PlayerId=OfflinePlayerUUID("character2"),
    ...
    c3 = M.Character(
        PlayerId=OfflinePlayerUUID("character3"),
